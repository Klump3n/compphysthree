...
\subsection{Frage 2}
Es werden zwei Zufallszahlen f\"ur einen Vorschlag ben\"otigt. Die
Akzeptanz wird mit diesen Zufallszahlen und den bereits bekannten Zahlen
bestimmt.
\begin{align*}
  \phi_{\text{x'}} = r_{\text{r}} + \mathrm{i} r_{\text{i}}
  \qquad \text{mit} \qquad r_{\text{r}}\,, r_{\text{i}} \in \text{\texttt{rand}}(0, 1]\,.
\end{align*}
